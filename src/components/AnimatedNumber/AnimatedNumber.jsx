...
const AnimatedNumber = () => {
  ...
  return (
    <ScrollTrigger
      ...
      <section className="relative mt-10 py-32 bg-[url('https://i.ibb.co/zFDNNdX/animated-bg.jpg')] bg-no-repeat bg-center bg-fixed bg-cover">
              ...
              <div className="grid md:grid-cols-3 grid-cols-1 items-center gap-6">
                <div
                  ...
                  <h1 className="text-white lg:text-gray-200xl text-4xl font-semibold mb-2">
                    {counterOn && (
                      <CountUp start={0} end={30000} duration={3} delay={0} />
                    )}
                    +
                  </h1>
